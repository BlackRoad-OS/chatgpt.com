...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/chatgpt.com.git
cd chatgpt.com

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/chatgpt.com.git
